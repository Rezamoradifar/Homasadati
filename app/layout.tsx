...
export async function generateMetadata():Promise<Metadata>{const locale=await siteLocale();return {title:locale==='en'?'Homay Saadat Club':locale==='ar'?'نادي عملاء هماي سعادت':'باشگاه مشتریان همای سعادت',description:locale==='en'?'The Homay Saadat club: travel, handicrafts, leather, beauty and technology.':locale==='ar'?'نادي عملاء هماي؛ السفر والحرف اليدوية والجلود والجمال والتكنولوجيا.':'باشگاه مشتریان هماي؛ گردشگری، صنایع‌دستی، چرم، زیبایی و فناوری.'};}
