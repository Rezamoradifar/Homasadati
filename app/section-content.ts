/** Operational copy describing implemented behavior; no invented accreditations or policies. */
export const sectionContent={
 ...
 faq:'Is submitting a request a booking? No: it is an enquiry. Are payments collected here? No. Can I check progress? Yes, using the private code on your receipt. Does club registration create a paid membership? No; it records your interest for review.',
 terms:'This site records enquiries, club interest and newsletter requests. Submission alone does not reserve a service, create a paid membership, or complete a purchase. Any offered service requires separate confirmation of scope, price and availability. Do not submit payment-card details or sensitive documents in the message field.',
 privacy:'The forms save your name, email, selected interest, message, language and currency preference on the site server so the team can review and respond. Newsletter requests save email and language. Only authenticated administrators can read the records. Language and currency preferences are saved in your browser. To request access or removal, contact the team using your tracking reference. No payment-card details are collected here.',
 refund:'This landing does not take payments, so it does not issue payment refunds. If you purchased a service through another channel, contact the team with your order reference. The applicable conditions must be confirmed for that order; do not send card or bank credentials.',
 },
 fa:{
 ...
 faq:'آیا ارسال فرم رزرو قطعی است؟ خیر، فقط درخواست بررسی است. آیا اینجا پرداخت انجام می‌شود؟ خیر. آیا می‌توان وضعیت را دید؟ بله، با کد خصوصی روی رسید. آیا ثبت‌نام باشگاه عضویت پولی ایجاد می‌کند؟ خیر، فقط علاقه‌مندی شما برای بررسی ثبت می‌شود.',
 terms:'این سایت درخواست خدمات، علاقه‌مندی به باشگاه و درخواست خبرنامه را ثبت می‌کند. ارسال فرم به‌تنهایی رزرو، خرید یا عضویت پولی ایجاد نمی‌کند. ارائهٔ هر خدمت نیازمند تأیید جداگانهٔ جزئیات، قیمت و ظرفیت است. اطلاعات کارت بانکی یا مدارک حساس را در متن پیام وارد نکنید.',
 privacy:'فرم‌ها نام، ایمیل، موضوع، پیام، زبان و واحد پول انتخابی شما را روی سرور سایت ذخیره می‌کنند تا تیم درخواست را بررسی و پاسخ دهد. خبرنامه ایمیل و زبان را ذخیره می‌کند. سوابق فقط برای مدیر واردشده قابل مشاهده‌اند. تنظیمات زبان و واحد پول در مرورگر شما نگه‌داری می‌شوند. برای درخواست دسترسی یا حذف اطلاعات، با ذکر شناسهٔ پیگیری از فرم تماس استفاده کنید. اطلاعات کارت بانکی در این سایت دریافت نمی‌شود.',
 refund:'این لندینگ پرداخت دریافت نمی‌کند؛ بنابراین بازپرداختی در آن انجام نمی‌شود. اگر از مسیر دیگری خرید داشته‌اید، با ذکر شناسهٔ سفارش با تیم تماس بگیرید. شرایط مربوط به همان سفارش باید بررسی شود؛ اطلاعات کارت یا رمز بانکی نفرستید.',
 },
 ar:{
 ...
 faq:'هل إرسال النموذج حجز مؤكد؟ لا، إنه استفسار. هل تُجمع المدفوعات هنا؟ لا. هل يمكن متابعة الطلب؟ نعم، برمز الإيصال الخاص. هل التسجيل في النادي عضوية مدفوعة؟ لا، إنه تعبير عن الاهتمام.',
 terms:'يسجل الموقع الاستفسارات والاهتمام بالنادي وطلبات النشرة. الإرسال وحده لا ينشئ حجزاً أو شراءً أو عضوية مدفوعة. الخدمات تحتاج تأكيداً منفصلاً للنطاق والسعر والتوفر. لا ترسل بيانات بطاقات الدفع أو وثائق حساسة في الرسالة.',
 privacy:'تحفظ النماذج الاسم والبريد والاهتمام والرسالة واللغة والعملة على الخادم للمراجعة والرد. تحفظ النشرة البريد واللغة. المديرون الموثقون فقط يمكنهم قراءة السجلات. تُحفظ تفضيلات اللغة والعملة في متصفحك. لطلب الوصول أو الحذف تواصل مع الفريق مع مرجع التتبع. لا نجمع بيانات بطاقات الدفع.',
 refund:'لا يستقبل هذا الموقع مدفوعات، ولذلك لا ينفذ استرداداً مالياً. إذا اشتريت عبر قناة أخرى فتواصل مع الفريق بمرجع الطلب لمراجعة شروطه. لا ترسل كلمات مرور أو بيانات مصرفية.'
 }
};
