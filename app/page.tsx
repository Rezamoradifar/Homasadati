...
function Landing({locale,setLocale}:{locale:Locale;setLocale:(locale:Locale)=>void}) {
 ...
 const changeCurrency=(value:string)=>setCurrency(value==='USD'?'USD':'IRR');
