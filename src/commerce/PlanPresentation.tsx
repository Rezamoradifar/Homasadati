...
export default function PlanPresentation() {
  ...
  const slides = [
    ...
    <section key="voucher" className="plan-slide">
      ...
      <ul className="plan-points">
        <li>در هر میز کار، از هر هشت تعادل، هفت پاداش نقدی به کیف پول واریز می‌شود.</li>
    ...
    <section key="week" className="plan-slide">
      ...
      <ol className="plan-steps">
        ...
        <li>
          <strong>بودجهٔ پاداش</strong>
          <span>جمع پاداش‌های هر هفته به سهم مشخصی از فروش همان هفته محدود است؛ بودجهٔ مصرف‌نشده به هفته‌های بعد می‌رود.</span>
        </li>
      </ol>
    </section>,
